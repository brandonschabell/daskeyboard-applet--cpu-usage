...
var FirewallGuard = /** @class */ (function (_super) {
    ...
    function FirewallGuard() {
        ...
        // run every 20 min
        _this.pollingInterval = 1000 * 60 * 20;
        return _this;
    }
    ...
    FirewallGuard.prototype.applyConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ports, firstPort, secondPort, errorMessage, length_1, range, i;
            return __generator(this, function (_a) {
                ...
                ports = this.config.portRange.split('-');
                firstPort = ports[0];
                secondPort = ports[1];
                errorMessage = [];
                 ...
                 */
                if (secondPort) {
                    length_1 = secondPort - firstPort + 1;
                    range = new Array(length_1);
